...
class ExecStartRequest(object):
    ...
    def __init__(self, scheme, endpoint, method, region_id, container_id, exec_id):
        self.__url = '%s://%s/v1/regions/%s/containers/%s:execStart?execId=%s' % \
                     (scheme, endpoint, region_id, container_id, exec_id)

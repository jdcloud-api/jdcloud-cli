...
class MpsController(BaseController):
    class Meta:
        ...
        description = 'mps cli 子命令，可以使用该子命令操作mps相关资源'
        stacked_on = 'base'
        stacked_type = 'nested'
    ...
    def create_thumbnail_task(self):
        ...
        try:
            ...
            params_dict = collect_user_args(self.app)
            req = CreateThumbnailTaskRequest(params_dict)
            resp = client.send(req)
            Printer.print_result(resp)
        except ImportError:
            print '{"error":"This api is not supported, please use the newer version"}'
    ...
    def get_thumbnail_task(self):
        ...
        try:
            ...
            params_dict = collect_user_args(self.app)
            req = GetThumbnailTaskRequest(params_dict)
            resp = client.send(req)
            Printer.print_result(resp)
        except ImportError:
            print '{"error":"This api is not supported, please use the newer version"}'
    ...
    def get_notification(self):
        ...
        try:
            ...
            params_dict = collect_user_args(self.app)
            req = GetNotificationRequest(params_dict)
            resp = client.send(req)
            Printer.print_result(resp)
        except ImportError:
            print '{"error":"This api is not supported, please use the newer version"}'
    ...
    def set_notification(self):
        ...
        try:
            ...
            params_dict = collect_user_args(self.app)
            req = SetNotificationRequest(params_dict)
            resp = client.send(req)
            Printer.print_result(resp)
        except ImportError:
            print '{"error":"This api is not supported, please use the newer version"}'

...
class RedisController(BaseController):
    class Meta:
        ...
        description = 'redis cli 子命令，可以使用该子命令操作redis相关资源'
        stacked_on = 'base'
        stacked_type = 'nested'
    ...
    @expose(
        ...
        description=""" 创建一个指定配置的缓存Redis实例。

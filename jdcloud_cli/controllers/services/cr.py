...
class CrController(BaseController):
    ...
    @expose(
        arguments=[
            ...
            (['--expired-after-hours'], dict(help="""(int) issue新token的过期时间, 可选参数为新生成令牌的过期时间，最大值为24小时，最小值为1小时，为空则默认为12小时过期时间。;  """, dest='expiredAfterHours', required=False)),

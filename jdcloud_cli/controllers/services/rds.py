...
class RdsController(BaseController):
    class Meta:
        ...
        description = 'rds cli 子命令，可以使用该子命令操作rds相关资源'
        stacked_on = 'base'
        stacked_type = 'nested'
    ...
    @expose(
        ...
        description=""" 从云数据库SQL Server备份中恢复单个数据库。
    ...
    @expose(
        ...
        description=""" 从用户上传的备份文件中恢复SQL Server数据库。

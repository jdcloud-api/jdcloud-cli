...
class MonitorController(BaseController):
    class Meta:
        ...
        description = 'monitor cli 子命令，可以使用该子命令操作monitor相关资源'
        stacked_on = 'base'
        stacked_type = 'nested'
    ...
    @expose(
        ...
        description=""" 启用报警规则，当客户的报警规则处于停止状态时，可以使用此接口启用报警规则。。
    ...
    @expose(
        arguments=[
            (['--api'], dict(help="""(string) api name """, choices=['describe-alarms','create-alarm','delete-alarms','describe-alarms-by-id','update-alarm','enable-alarm','disable-alarm','describe-alarm-history','describe-metrics','describe-metrics-for-create-alarm','describe-metric-data',], required=True)),
        ],

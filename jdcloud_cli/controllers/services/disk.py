...
class DiskController(BaseController):
    class Meta:
        ...
        description = 'disk cli 子命令，可以使用该子命令操作disk相关资源'
        stacked_on = 'base'
        stacked_type = 'nested'
    ...
    def describe_disks(self):
        ...
        try:
            ...
            req = DescribeDisksRequest(params_dict)
    ...
    def create_disks(self):
        ...
        try:
            ...
            params_dict = collect_user_args(self.app)
            req = CreateDisksRequest(params_dict)
            resp = client.send(req)
            Printer.print_result(resp)
        except ImportError:
            print '{"error":"This api is not supported, please use the newer version"}'
    ...
    def describe_disk(self):
        ...
        try:
            ...
            params_dict = collect_user_args(self.app)
            req = DescribeDiskRequest(params_dict)
            resp = client.send(req)
            Printer.print_result(resp)
        except ImportError:
            print '{"error":"This api is not supported, please use the newer version"}'
    ...
    def modify_disk_attribute(self):
        ...
        try:
            ...
            params_dict = collect_user_args(self.app)
            req = ModifyDiskAttributeRequest(params_dict)
            resp = client.send(req)
            Printer.print_result(resp)
        except ImportError:
            print '{"error":"This api is not supported, please use the newer version"}'
    ...
    def delete_disk(self):
        ...
        try:
            ...
            params_dict = collect_user_args(self.app)
            req = DeleteDiskRequest(params_dict)
            resp = client.send(req)
            Printer.print_result(resp)
        except ImportError:
            print '{"error":"This api is not supported, please use the newer version"}'
    ...
    def restore_disk(self):
        ...
        try:
            ...
            params_dict = collect_user_args(self.app)
            req = RestoreDiskRequest(params_dict)
            resp = client.send(req)
            Printer.print_result(resp)
        except ImportError:
            print '{"error":"This api is not supported, please use the newer version"}'
    ...
    def extend_disk(self):
        ...
        try:
            ...
            params_dict = collect_user_args(self.app)
            req = ExtendDiskRequest(params_dict)
            resp = client.send(req)
            Printer.print_result(resp)
        except ImportError:
            print '{"error":"This api is not supported, please use the newer version"}'
    ...
    def describe_snapshots(self):
        ...
        try:
            ...
            params_dict = collect_user_args(self.app)
            req = DescribeSnapshotsRequest(params_dict)
            resp = client.send(req)
            Printer.print_result(resp)
        except ImportError:
            print '{"error":"This api is not supported, please use the newer version"}'
    ...
    @expose(
        ...
        description=""" 为指定云硬盘创建快照,新生成的快照的状态为creating。
    ...
    def create_snapshot(self):
        ...
        try:
            ...
            params_dict = collect_user_args(self.app)
            req = CreateSnapshotRequest(params_dict)
            resp = client.send(req)
            Printer.print_result(resp)
        except ImportError:
            print '{"error":"This api is not supported, please use the newer version"}'
    ...
    def describe_snapshot(self):
        ...
        try:
            ...
            params_dict = collect_user_args(self.app)
            req = DescribeSnapshotRequest(params_dict)
            resp = client.send(req)
            Printer.print_result(resp)
        except ImportError:
            print '{"error":"This api is not supported, please use the newer version"}'
    ...
    def modify_snp_attribute(self):
        ...
        try:
            ...
            params_dict = collect_user_args(self.app)
            req = ModifySnpAttributeRequest(params_dict)
            resp = client.send(req)
            Printer.print_result(resp)
        except ImportError:
            print '{"error":"This api is not supported, please use the newer version"}'
    ...
    @expose(
        ...
        description=""" 删除单个云硬盘快照:快照状态必须为 available 或 error 状态。
    ...
    def delete_snapshot(self):
        ...
        try:
            ...
            params_dict = collect_user_args(self.app)
            req = DeleteSnapshotRequest(params_dict)
            resp = client.send(req)
            Printer.print_result(resp)
        except ImportError:
            print '{"error":"This api is not supported, please use the newer version"}'

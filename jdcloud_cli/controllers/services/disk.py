...
class DiskController(BaseController):
    ...
    @expose(
        arguments=[
            (['--api'], dict(help="""(string) api name """, choices=['describe-snapshots','create-snapshot','describe-snapshot','modify-snp-attribute','delete-snapshot','describe-disks','create-disks','describe-disk','modify-disk-attribute','delete-disk','restore-disk','extend-disk',], required=True)),
        ],
        formatter_class=RawTextHelpFormatter,
